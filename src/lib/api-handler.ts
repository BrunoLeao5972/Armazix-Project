...
import {
  ...
  createServicePointHandler,
  updateServicePointHandler,
  deleteServicePointHandler,
  batchCreateServicePointsHandler,
  openServicePointSessionHandler,
...
const protectedPostRoutes: Record<string, ApiHandler> = {
  ...
  "/api/service-points/create":       createServicePointHandler,
  "/api/service-points/update":       updateServicePointHandler,
  "/api/service-points/delete":       deleteServicePointHandler,
...
const protectedGetRoutes: Record<string, ApiHandler> = {
  ...
  "/api/customers/get": getCustomerHandler,
