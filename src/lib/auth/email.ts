...
export async function sendTeamInviteEmail(
  ...
  return getResend().emails.send({
    from: FROM,
    to: email,
    subject: `${storeName} convidou você para a equipe — ARMAZIX`,
    html: teamInviteTemplate(name, storeName, roleLabel, acceptUrl),
  });
}
...
function teamInviteTemplate(name: string, storeName: string, roleLabel: string, acceptUrl: string): string {
  return `
<!DOCTYPE html>
<html>
<head>
